...
sifirlama();
    ...
    sonuc:
    printf("%d",100*dizi_1[1]+dizi_1[2]);
    return 0;
}
...
for(i=0;i<173;i+=4)
    {
        if(dizi_1[i]==1)
        {
        dizi_1[dizi_1[i+3]]=dizi_1[dizi_1[i+1]]+dizi_1[dizi_1[i+2]];
        }
        else if(dizi_1[i]==2)
        {
        dizi_1[dizi_1[i+3]]=dizi_1[dizi_1[i+1]]*dizi_1[dizi_1[i+2]];
